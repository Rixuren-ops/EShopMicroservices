...
namespace Ordering.Infrastructure.Data.Extensions
{
    public class InitialData
    {
        ...
        public static IEnumerable<Order> OrdersWithItems(List<Customer> customers, List<Product> products)
        {

            var address1 = Address.Of("mehmet", "ozkaya", "mehmet@gmail.com", "bahcelievier No:4", "Turkey", "Istanbul", "38050");
            ...
            var payment2 = Payment.Of("john", "4111111111111111", "06/30", "222", 1);
            ...
            order1.Add(products[0].Id, products[0].Price, 2);
            order1.Add(products[1].Id, products[1].Price, 1);
            ...
            order2.Add(products[2].Id, products[2].Price, 1);
            order2.Add(products[3].Id, products[3].Price, 2);
