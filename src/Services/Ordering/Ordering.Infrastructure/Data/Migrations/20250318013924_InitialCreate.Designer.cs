...
namespace Ordering.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250318013924_InitialCreate")]
            ...
            modelBuilder.Entity("Ordering.Domain.Models.Order", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("BillingAddress", "Ordering.Domain.Models.Order.BillingAddress#Address", b1 =>
                        {
                            ...
                            b1.Property<string>("EmailAddres")
                                .IsRequired()
                                .HasMaxLength(50)
                                .HasColumnType("nvarchar(50)");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("ShippingAddres", "Ordering.Domain.Models.Order.ShippingAddres#Address", b1 =>
                        {
                            b1.IsRequired();
